...
from dataset.nms import oks_nms
from dataset.nms import soft_oks_nms

from dataset.kpt_2d_base import Kpt2dSviewRgbImgTopDownDataset
from dataset.dataset_info import DatasetInfo
from dataset.ap10k_info import ap10k_info
...
class AnimalAP10KDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def __init__(self,
        ...
        datas = ap10k_info
        dataset_info = DatasetInfo(datas)
